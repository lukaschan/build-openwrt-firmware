...
echo "src-git mosdns https://github.com/sbwml/luci-app-mosdns.git;packages" >> feeds.conf.default
echo "src-git mosdns https://github.com/sbwml/v2ray-geodata.git;packages" >> feeds.conf.default
